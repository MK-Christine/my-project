...
$id = $_GET['id'];
$stud=mysqli_query($con, "select * from teachers where id=$id");
...
if(isset($_POST ['submit'])) {
   ...
   $insert=mysqli_query($con, "UPDATE teachers SET firstname='$firstname',lastname='$lastname',username='$username' where id=$id ");
   if($insert){
   ...
   <div class="col-3"></div>
             <div class="col-6">
                      ...
                      <h3 class="mb-4">Edit student </h3>
                        ...
                        <input type="text" placeholder="usename" class="form-control mt-2"name="uname" value="<?php echo $row['username']?>" >           
